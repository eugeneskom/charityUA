...
function Breadcrumbs({ currentPage }: { currentPage: string }) {
  ...
  return (
    <nav className="flex px-5 mb-5 py-3 text-gray-700 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-800 dark:border-gray-700" aria-label="Breadcrumb">
      <ol className="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
        ...
        <li>
          <div className="flex items-center">
            ...
            <span className="ms-1 text-sm font-medium text-gray-700  md:ms-2 dark:text-gray-400 dark:hover:text-white">
              {currentPage}
            </span>
          </div>
        </li>
